...
class ClearCommand(commands.Cog):
    ...
    @commands.slash_command(name="clear", description="Удаляет указанное количество сообщений")
    async def slash_clear(self, ctx, reason: int = commands.Param(name="amount")):
